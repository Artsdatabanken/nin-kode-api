...
namespace NiN.Database.Migrations
{
    ...
    [Migration("20211126104506_Grunntyper")]
    partial class Grunntyper
    {
            ...
            modelBuilder.Entity("GrunntypeKartleggingsenhet", b =>
                {
                    ...
                    b.ToTable("GrunntypeKartleggingsenhet");
                });
            ...
            modelBuilder.Entity("GrunntypeMiljovariabel", b =>
                {
                    ...
                    b.ToTable("GrunntypeMiljovariabel");
                });
            ...
            modelBuilder.Entity("GrunntypeKartleggingsenhet", b =>
                {
                    ...
                    b.HasOne("NiN.Database.Models.Code.Kartleggingsenhet", null)
                        .WithMany()
                        .HasForeignKey("KartleggingsenhetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("GrunntypeMiljovariabel", b =>
                {
                    ...
                    b.HasOne("NiN.Database.Models.Code.Miljovariabel", null)
                        .WithMany()
